...
// .svelte-kit/output/server/chunks/layout-4e860a9f.js
var layout_4e860a9f_exports = {};
__export(layout_4e860a9f_exports, {
  default: () => Layout
});
var Layout;
var init_layout_4e860a9f = __esm({
  ".svelte-kit/output/server/chunks/layout-4e860a9f.js"() {
    init_shims();
    init_app_85c6ba1d();
...
// .svelte-kit/output/server/chunks/error-10f6f3d9.js
var error_10f6f3d9_exports = {};
__export(error_10f6f3d9_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-22efac9a.js
var index_22efac9a_exports = {};
__export(index_22efac9a_exports, {
  default: () => Routes
});
...
var css$6, LightboxThumbnail, css$5, LightboxHeader, css$4, LightboxBody, css$3, LightboxFooter, css$2, ModalCover, css$1, Modal, subscriber_queue, Index, css, InternalGallery, BodyChild, Lightbox, translations, Routes;
var init_index_22efac9a = __esm({
  ".svelte-kit/output/server/chunks/index-22efac9a.js"() {
    init_shims();
    init_app_85c6ba1d();
    css$6 = {
    ...
    LightboxThumbnail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    LightboxHeader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      createEventDispatcher();
      let { size = "xs" } = $$props;
      let { style = "" } = $$props;
    ...
    LightboxBody = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let imageClass;
    ...
    LightboxFooter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { title = "" } = $$props;
    ...
    ModalCover = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    InternalGallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let activeImage;
...
<div class="${["wrapper svelte-1lrmlbr", fullscreen ? "fullscreen" : ""].join(" ").trim()}" style="${"--svelte-lightbox-arrows-color: " + escape(galleryArrowsColor)}">
    ...
    BodyChild = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    Lightbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    translations = [
      {
        ...
        imageUrl: "Rokade.jpg",
        imageAlt: "Rokade",
        title: "Rokade - een schaakroman",
        content1: "Hoofdpersoon is de apotheker Ewoud van E. Tot zijn ontzetting ontdekt hij een complot om hem uit zijn winkeltje te werken. Hij voelt zich bedreigd. Natuurlijk stuurt zijn huisarts, Lode Priester hem naar de psychiater. Maar bij deze specialist, dr. Helleman, durft hij niet over zijn ontdekkingen te spreken - uit angst om gek te worden verklaard. Hij vertelt hem onder meer over de voordelen van het vega-leven en de charme van het schaken in een club.",
        content2: "Voor het eerst gaat hij een dagboek bijhouden. Daarin beschrijft hij de samenzwering w\xE9l. Hij voelt zich de belaagde koning in een schaakpartij tegen een Meesterschaker. Voorlopig kan hij zich nog troosten met zijn vrouw Mousa, hun dochtertje en zijn vioolspel. Maar de spanning in zijn leven loopt ondraaglijk op. Hoe moet dit aflopen? Deze \u2013 hier en daar hilarische \u2013 roman is als een schaakspel opgebouwd. De Duitse vertaling is een door de auteur ingekorte versie van het origineel.",
        storeUrl: "https://www.bol.com/nl/p/rokade/9200000010442164/",
        storeDescription: "Rokade op bol.com"
      },
      {
        lang: "Deutsch",
        imageUrl: "Rochade.png",
        imageAlt: "Rochade",
        title: "Rochade - Ein Schachroman",
        content1: "Die Hauptperson, der Apotheker Ewoud van E, entdeckt zu seinem Entsetzen einen gegen ihn geschmiedeten Komplott: Man versucht, ihn aus seinem Gesch\xE4ft zu vertreiben. Er f\xFChlt sich bedroht. Nat\xFCrlich \xFCberweist sein Hausarzt, Lode Priester, ihn an einen Psychiater. Bei diesem Spezialisten traut sich der Apotheker aber nicht, \xFCber seine Entdeckung zu sprechen. Allzu gro\xDF ist die Angst, f\xFCr verr\xFCckt erkl\xE4rt zu werden. Er spricht aber mit ihm \xFCber die Vorz\xFCge einer veganen Lebensweise und \xFCber den Reiz der Mitgliedschaft in einem Schachklub.",
        content2: "Zum ersten Mal in seinem Leben f\xFChrt er ein Tagebuch, in dem er die Verschw\xF6rung sehr wohl thematisiert. Er sieht sich als den bedrohten K\xF6nig in einem Spiel gegen einen Schachmeister. Vorerst findet er noch Trost bei seiner Frau Mousa, der kleinen Tochter und dem Geigenspiel. Die Spannung in seinem Leben steigert sich aber bis zum Unertr\xE4glichen. Wie soll das ausgehen? Dieser stellenweise komische Roman ist wie ein Schachspiel konstruiert. Die deutsche \xDCbersetzung ist eine vom Autor gek\xFCrzte Fassung des niederl\xE4ndischen Originals.",
        storeDescription: "F\xFCr Bestellungen k\xF6nnen Sie Ihre Kontaktdaten an die unten angegebene E-Mail-Adresse senden. Er wird sich dann so schnell wie m\xF6glich mit Ihnen in Verbindung setzen."
      }
    ];
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let selectedTranslation = translations[0];
      return `<div class="${"flex-container"}"><div class="${"title"}"><h2>Hein Heijnen</h2></div>

	<div class="${"booknav"}"><h3>Maanlichtverhalen</h3>                    
            <p>Ge\xEFnspireerd door A L Snijders werkt Hein Heijnen aan een nieuwe bundel korte verhalen. De titel luidt: Maanlichtverhalen.
                Onderstaande knop opent een voorproefje. <br> 
                <button>&#39;Uw naam?&#39;</button>
                ${``}</p>

		<h3>Toverdrankjes voor geluk</h3>

		<div class="${"books"}"><div class="${"image_div"}">${validate_component(Lightbox, "Lightbox").$$render($$result, {}, {}, {
        default: () => `<img src="${"images\\Toverdrankjes.jpg"}" alt="${"Toverdrankjes"}">`
      })}</div>

			<p class="${"content"}">De bundel Toverdrankjes voor Geluk bevat 20 duetten, een samenspel van Hein Heijnen en Merik
				van der Torren. Elk duet bestaat uit een verhaal gevolgd door een passend gedicht. De sfeer
				is meestal opgewekt-weemoedig. In de meeste verhalen speelt de troost door muziek een rol.
				Volgens de filosoof Plato dringt niets zo diep door in het binnenste van de ziel als ritme
				en melodie. Hier en daar blinken vonkjes van tegendraadse humor, waarmee de schrijvers ons
				bijlichten op zoek naar identiteit en geluk.
				<br>
				<a href="${"https://www.bol.com/nl/p/toverdrankjes-voor-geluk/9200000081928113/"}">Toverdrankjes voor geluk op bol.com <i class="${"material-icons"}">library_add</i></a></p></div>

		<div lang="${"nl"}" id="${"rokkade"}"><h3>${escape(selectedTranslation.title)}</h3>
			<button>${escape("Deutsch")}</button>
			<br>
			<br>
			<div class="${"books"}"><div class="${"image_div"}">${validate_component(Lightbox, "Lightbox").$$render($$result, {}, {}, {
        default: () => `<img src="${"images\\" + escape(selectedTranslation.imageUrl)}"${add_attribute("alt", selectedTranslation.imageAlt, 0)}>`
      })}</div>

				<p class="${"content"}">${escape(selectedTranslation.content1)}
					<br>
					<br>
					${escape(selectedTranslation.content2)}
					<br>
                    ${`<a${add_attribute("href", selectedTranslation.storeUrl, 0)}>${escape(selectedTranslation.storeDescription)}<i class="${"material-icons"}">library_add</i></a>`}</p></div></div></div>

	<div class="${"about"}"><h3>Over de auteur</h3>
		Van jongs af aan ontmoette Hein Heijnen zonderlinge figuren in wie hij zich herkende. Liefdevol schetst
		hij ze in zijn flitsverhalen. Hij speelt iedere dag piano, ook in een trio dat de blues en songs
		uit The American Songbook brengt.In 2014 verscheen zijn schaakroman Rokade. Momenteel werkt Hein
		Heijnen aan een bundel korte verhalen.
	</div>

	<div class="${"contact"}"><h3>Contact</h3>
		E-mail: <a href="${"mailto:hein.vanderkroon@gmail.com"}">hein.vanderkroon@gmail.com</a></div></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-85c6ba1d.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-4b64f617.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-a0137619.css"],
      js: [assets + "/_app/start-4b64f617.js", assets + "/_app/chunks/vendor-9b4dc6bd.js"]
    },
    fetched: void 0,
    floc: false,
...
var __accessCheck, __privateGet, __privateAdd, __privateSet, _map, absolute, scheme, chars, unsafeChars, reserved, escaped$1, objectProtoOwnPropertyNames, subscriber_queue2, escape_json_string_in_html_dict, escape_html_attr_dict, s$1, s, ReadOnlyFormData, current_component, boolean_attributes, invalid_attribute_name_character, escaped, missing_component, on_destroy, css2, Root, base, assets, user_hooks, template, options, default_settings, empty, manifest, get_hooks, module_lookup, metadata_lookup;
var init_app_85c6ba1d = __esm({
  ".svelte-kit/output/server/chunks/app-85c6ba1d.js"() {
    init_shims();
...
${``}`;
    ...
    template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<title>Homepage van de auteur Hein Heijnen</title>\n		<meta charset="utf-8" />\n		<meta name="description" content="Homepage van de auteur Hein Heijnen" />\n		<link rel="icon" href="images/favicon.ico" />\n		<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons" />\n		<link rel="stylesheet" href="css/sakura.css" />\n		<link rel="stylesheet" href="css/style.css" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body>\n		<div id="svelte">' + body + "</div>\n	</body>\n</html>\n";
    options = null;
    default_settings = { paths: { "base": "", "assets": "" } };
    empty = () => ({});
    manifest = {
      assets: [{ "file": "css/sakura.css", "size": 3474, "type": "text/css" }, { "file": "css/style.css", "size": 720, "type": "text/css" }, { "file": "images/favicon.ico", "size": 32038, "type": "image/vnd.microsoft.icon" }, { "file": "images/Rochade.png", "size": 315459, "type": "image/png" }, { "file": "images/Rokade.jpg", "size": 89781, "type": "image/jpeg" }, { "file": "images/Sakura-background.jpg", "size": 98654, "type": "image/jpeg" }, { "file": "images/Toverdrankjes.jpg", "size": 100814, "type": "image/jpeg" }],
    ...
    module_lookup = {
      ".svelte-kit/build/components/layout.svelte": () => Promise.resolve().then(() => (init_layout_4e860a9f(), layout_4e860a9f_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_10f6f3d9(), error_10f6f3d9_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_22efac9a(), index_22efac9a_exports))
    };
    metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-dc458ffb.js", "css": ["assets/vendor-a0137619.css"], "js": ["layout.svelte-dc458ffb.js", "chunks/vendor-9b4dc6bd.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-adc0aab4.js", "css": ["assets/vendor-a0137619.css"], "js": ["error.svelte-adc0aab4.js", "chunks/vendor-9b4dc6bd.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-c238ea08.js", "css": ["assets/vendor-a0137619.css"], "js": ["pages/index.svelte-c238ea08.js", "chunks/vendor-9b4dc6bd.js"], "styles": [] } };
  }
});
